export const zh = {
  ...
  tasksStop: '停止任务',
  todoList: '待办清单',
  liveThinking: 'Claude 正在思考',
  liveWaiting: '正在处理结果',
  liveCompacting: '正在压缩上下文',
  contextUsed: '上下文已用',
  contextAria: '上下文已用 {percent}',
  contextOverLimit: '已超出上下文窗口',
  contextDeferred: '按需加载',
  contextBreakdownTitle: '消息构成',
  contextBreakdownToolResults: '工具结果',
  contextBreakdownToolCalls: '工具调用',
  contextBreakdownAttachments: '附件',
  contextBreakdownAssistant: '助手回复',
  contextBreakdownUser: '用户消息',
  contextBreakdownRedirected: '重定向的上下文',
  contextAutoCompactOn: '自动压缩：开（~{tokens} · {percent}%）',
  contextAutoCompactOff: '自动压缩：关',
  contextLastCompaction: '上次压缩：{trigger} {pre} → {post} · {seconds}s',
  statsTurns: '{turns} 轮',
  statsCounts: '{turns} 轮 {steps} 步',
  statsPerSecond: '{tps} tok/s',
  statsTokens: '{count} tok',
  statsCacheHit: '缓存命中 {percent}%',
  statsTimeTitle: '会话统计',
  statsUsageTitle: 'Token 用量',
  statsDialogTurns: '轮次',
  statsDialogSteps: '模型调用',
  statsDialogApiTime: '模型用时',
  statsDialogWallTime: '本轮总用时',
  statsDialogTtft: '首 token 平均',
  statsDialogSpeed: '输出速度（TPS）',
  statsDialogCacheHit: '缓存命中',
  statsDialogInput: '未缓存输入',
  statsDialogCacheRead: '缓存读取',
  statsDialogCacheWrite: '缓存写入',
  statsDialogOutput: '输出',
  statsDialogTotal: '合计',
  statsDialogCost: '累计成本',
  statsSource: '由 Claude Code 自己的用量报告汇总：一轮是一次 DSH 步骤，其中包含它自己的全部模型调用。该会话的上下文属于 Claude Code，压缩由它自己做。',
  contextCategorySystemPrompt: '系统提示词',
  contextCategorySystemTools: '工具定义',
  contextCategoryMcpTools: 'MCP 工具',
  contextCategoryMemory: '记忆文件',
  contextCategoryMessages: '对话消息',
  contextCategorySkills: '技能',
  contextCategoryAgents: '子代理',
  contextCategoryFree: '剩余空间',
  liveTool: '正在运行 {tool}',
  liveToolUnknown: '工具',
  tasksStopping: '停止中…',
  tasksStopUnavailable: '该任务已不在运行',
...
export const en = {
  ...
  tasksStop: 'Stop task',
  todoList: 'Todo list',
  liveThinking: 'Claude is thinking',
  liveWaiting: 'Working through the result',
  liveCompacting: 'Compacting the context',
  contextUsed: 'Context used',
  contextAria: 'Context {percent} used',
  contextOverLimit: 'Past the context window',
  contextDeferred: 'deferred',
  contextBreakdownTitle: 'What the messages are',
  contextBreakdownToolResults: 'Tool results',
  contextBreakdownToolCalls: 'Tool calls',
  contextBreakdownAttachments: 'Attachments',
  contextBreakdownAssistant: 'Assistant replies',
  contextBreakdownUser: 'User messages',
  contextBreakdownRedirected: 'Redirected context',
  statsTurns: '{turns} turns',
  statsCounts: '{turns} turns {steps} steps',
  statsPerSecond: '{tps} tok/s',
  statsTokens: '{count} tok',
  statsCacheHit: 'Cache hit {percent}%',
  statsTimeTitle: 'Session statistics',
  statsUsageTitle: 'Token usage',
  statsDialogTurns: 'Turns',
  statsDialogSteps: 'Model calls',
  statsDialogApiTime: 'Model time',
  statsDialogWallTime: 'Turn wall time',
  statsDialogTtft: 'Avg time to first token',
  statsDialogSpeed: 'Tokens per second (TPS)',
  statsDialogCacheHit: 'Cache hit',
  statsDialogInput: 'Uncached input',
  statsDialogCacheRead: 'Cache read',
  statsDialogCacheWrite: 'Cache write',
  statsDialogOutput: 'Output',
  statsDialogTotal: 'Total',
  statsDialogCost: 'Total cost',
  statsSource: "Summed from Claude Code's own usage reports: a turn here is one DSH step, holding every model call it made. The session's context belongs to Claude Code, which compacts it on its own.",
  contextAutoCompactOn: 'Auto-compact: on (~{tokens} · {percent}%)',
  contextAutoCompactOff: 'Auto-compact: off',
  contextLastCompaction: 'Last compaction: {trigger} {pre} → {post} · {seconds}s',
  contextCategorySystemPrompt: 'System prompt',
  contextCategorySystemTools: 'Tool definitions',
  contextCategoryMcpTools: 'MCP tools',
  contextCategoryMemory: 'Memory files',
  contextCategoryMessages: 'Messages',
  contextCategorySkills: 'Skills',
  contextCategoryAgents: 'Agents',
  contextCategoryFree: 'Free space',
  liveTool: 'Running {tool}',
  liveToolUnknown: 'a tool',
  tasksStopping: 'Stopping…',
  tasksStopUnavailable: 'That task is no longer running',
